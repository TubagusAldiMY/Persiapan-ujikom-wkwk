...
// --- PERUBAHAN DI SINI ---
// Gunakan kelas Database untuk koneksi
...
// Tidak ada perubahan pada query, hanya memastikan $connection sudah benar
...
$stmt_faktur = mysqli_prepare($connection, $query_faktur);
mysqli_stmt_bind_param($stmt_faktur, "i", $id_faktur);
mysqli_stmt_execute($stmt_faktur);
$result_faktur = mysqli_stmt_get_result($stmt_faktur);
...
mysqli_stmt_bind_param($stmt_items, "i", $id_faktur);
